<div>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Edit Role: <span class="capitalize">{{ $role->name }}</span></h1>
            ...
            <form wire:submit.prevent="update">
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mb-6">Select the permissions this role should have. Changes will affect all users assigned to this role.</p>
                                    ...
                                    <div class="border border-gray-200 rounded-lg p-4">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="text-xs text-gray-500">
                                                {{ $permissions->whereIn('name', $selectedPermissions)->count() }} / {{ $permissions->count() }} selected
                                            </span>
                                        </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <div class="flex items-center justify-between text-sm text-gray-600">
                            <div>
                                <span class="font-medium">{{ $role->users()->count() }}</span> users currently assigned to this role
                            </div>
                            <div>
