<div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form wire:submit.prevent="update">
            ...
            <!-- Cost Section -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold mb-4">{{ __('Cost Management') }}</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                        <label for="approved_cost" class="block text-sm font-medium text-gray-700">{{ __('Approved Cost') }}</label>
                        <input wire:model="approved_cost" type="number" step="0.01" id="approved_cost" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        @error('approved_cost') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label for="final_cost" class="block text-sm font-medium text-gray-700">{{ __('Final Cost') }}</label>
                        <input wire:model="final_cost" type="number" step="0.01" id="final_cost" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        @error('final_cost') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                </div>
            ...
            @if($status === 'completed')
            <div class="mb-6">
                <h3 class="text-lg font-semibold mb-4">{{ __('Completion Details') }}</h3>
                
                <div class="mb-4">
                    <label for="completion_notes" class="block text-sm font-medium text-gray-700">{{ __('Completion Notes') }}</label>
                    <textarea wire:model="completion_notes" id="completion_notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                    @error('completion_notes') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="tenant_satisfaction_rating" class="block text-sm font-medium text-gray-700">{{ __('Tenant Rating (1-5)') }}</label>
                        <input wire:model="tenant_satisfaction_rating" type="number" min="1" max="5" id="tenant_satisfaction_rating" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        @error('tenant_satisfaction_rating') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label for="tenant_feedback" class="block text-sm font-medium text-gray-700">{{ __('Tenant Feedback') }}</label>
                        <textarea wire:model="tenant_feedback" id="tenant_feedback" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                        @error('tenant_feedback') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
            @endif
