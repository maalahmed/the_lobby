            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-bold text-gray-800">{{ __('Edit Invoice') }}: {{ $invoice->invoice_number }}</h2>
                        <a href="{{ route('admin.invoices.show', $invoice) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                            {{ __('Back to Invoice') }}
                        </a>
                    </div>
                    ...
                    <form wire:submit="update">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                <label for="paid_amount" class="block text-sm font-medium text-gray-700">{{ __('Paid Amount') }}</label>
                                <input wire:model="paid_amount" type="number" step="0.01" id="paid_amount" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <p class="mt-1 text-xs text-gray-500">{{ __('Amount already paid by tenant') }}</p>
